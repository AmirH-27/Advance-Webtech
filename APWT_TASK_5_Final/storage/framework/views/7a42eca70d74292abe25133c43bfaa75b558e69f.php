...
unset($__errorArgs, $__bag); ?>
        ...
        <div class ="col-md-4 form-group">
            ...
            <input type="text" name="dob" value = "<?php echo e($user->dob); ?>" class = "form-control"><br>
            <?php $__errorArgs = ['id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\xampp\htdocs\AdWt\APWT_TASK_3\resources\views/PagesAdmin/editUser.blade.php ENDPATH**/ ?>